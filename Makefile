## Old-fashioned Makefile for use without autoconf

CFLAGS=-O2 -flto=auto -ffat-lto-objects -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -DLINUX -D_REENTRANT -D_GNU_SOURCE -DUSE_KEY_DATABASE -I/usr/include/apache2 -I/usr/include/apr-1.0
CXXFLAGS=$(CFLAGS)
...
mod_mapnik_wms.o: mod_mapnik_wms.c
	cc $(CFLAGS) -c mod_mapnik_wms.c -o mod_mapnik_wms.o
